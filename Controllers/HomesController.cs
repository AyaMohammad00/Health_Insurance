...
namespace Health_Insurance.Controllers
{
    public class HomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Logo,Homeimage,Content,Facebook,Instgram,Email,Phone")] Home home)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Logo,Homeimage,Content,Facebook,Instgram,Email,Phone")] Home home)
        {
            if (id != home.Id)
            {
                return NotFound();
