...
namespace Health_Insurance.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Image,Content")] Aboutu aboutu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Image,Content")] Aboutu aboutu)
        {
            if (id != aboutu.Id)
            {
                return NotFound();
