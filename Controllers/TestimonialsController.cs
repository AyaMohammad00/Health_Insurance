...
namespace Health_Insurance.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Testimonialid,Userid,Username,Message,Status,Image")] Testimonial testimonial)
        {
            ...
            ViewData["Userid"] = new SelectList(_context.Userccounts, "Userid", "Userid", testimonial.Userid);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Testimonialid,Userid,Username,Message,Status,Image")] Testimonial testimonial)
        {
