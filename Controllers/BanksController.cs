...
namespace Health_Insurance.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Bankid,Cardnumber,Ownername,Balance,Cvv")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Bankid,Cardnumber,Ownername,Balance,Cvv")] Bank bank)
        {
            if (id != bank.Bankid)
            {
                return NotFound();
