...
namespace Health_Insurance.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Message,Phonenumber")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Email,Message,Phonenumber")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
